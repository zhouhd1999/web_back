...
import java.util.List;
  ...
  //  @Select("SELECT * FROM article, `user`,tag WHERE article_id = 2")
    ...
    //修改文章
    @Update("UPDATE article SET tag_id = #{tagId},article_name = #{articleName},article_date_time = #{articleDateTime} ,article_content = #{articleContent},article_state = #{articleState} WHERE article_id = #{articleId}")
